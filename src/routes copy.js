...
const routes = [
  ...
  { path: '/:pageId', name: 'enrollment', title__main: '상품',title__sub: '상품 자세히 보기',content__main: Colors, content__sub: Typography, layout: Sub },
  // { path: '/:pageId', name: 'enrollment', title__Main: '상품',title__Sub: '상품 자세히 보기', component: Colors, layout: Sub },
  { path: '/:pageId', name: 'arrival', title__main: '출고시작',title__sub: '입고서', content__main: Breadcrumbs, content__sub: Navbars, layout: Sub },
